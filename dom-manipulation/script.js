document.addEventListener('DOMContentLoaded', () => {
    ...
    async function syncWithServer() {
        try {
            // Fetch data from the server (mock API)
            ...
            // Merge local quotes with server quotes, giving priority to server quotes
            quotes = [...transformedQuotes, ...quotes.filter(localQuote =>
